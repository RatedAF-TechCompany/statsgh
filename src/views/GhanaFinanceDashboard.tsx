...
const GhanaFinanceDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        {/* Navigation */}
        <Button variant="ghost" onClick={() => router.push("/data")} className="mb-4">
            ...
            <Card className="lg:col-span-1">
              ...
              <CardContent>
                ...
                <div className="mt-2 flex justify-end">
                  <Button variant="ghost" size="sm" onClick={() => router.push(`/data/${gdp.slug}`)}>
          ...
          {inflation && inflation.chartData.length > 0 && (
            <Card className="lg:col-span-1">
              ...
              <CardContent>
                ...
                <div className="mt-2 flex justify-end">
                  <Button variant="ghost" size="sm" onClick={() => router.push(`/data/${inflation.slug}`)}>
                    View Details <ExternalLink size={14} className="ml-1" />
                  </Button>
                </div>
              </CardContent>
          ...
          {exchangeRate && exchangeRate.chartData.length > 0 && (
            <Card className="lg:col-span-1">
              ...
              <CardContent>
                ...
                <div className="mt-2 flex justify-end">
                  <Button variant="ghost" size="sm" onClick={() => router.push(`/data/${exchangeRate.slug}`)}>
                    View Details <ExternalLink size={14} className="ml-1" />
                  </Button>
                </div>
              </CardContent>
          ...
          {policyRate && policyRate.chartData.length > 0 && (
            <Card className="lg:col-span-1">
              ...
              <CardContent>
                ...
                <div className="mt-2 flex justify-end">
                  <Button variant="ghost" size="sm" onClick={() => router.push(`/data/${policyRate.slug}`)}>
                    View Details <ExternalLink size={14} className="ml-1" />
                  </Button>
                </div>
              </CardContent>
          ...
          {debtGdp && debtGdp.chartData.length > 0 && (
            <Card className="lg:col-span-2">
              ...
              <CardContent>
                ...
                <div className="mt-2 flex justify-end">
                  <Button variant="ghost" size="sm" onClick={() => router.push(`/data/${debtGdp.slug}`)}>
                    View Details <ExternalLink size={14} className="ml-1" />
                  </Button>
                </div>
              </CardContent>
        ...
        {relatedNews && relatedNews.length > 0 && (
          <section className="mb-8">
            <div className="flex items-center justify-between mb-4">
              ...
              <Button variant="ghost" size="sm" onClick={() => router.push("/search?q=economy")}>
                View All
              </Button>
            </div>
