    ...
    return (
      <div className="min-h-screen bg-[#FFFFFF]">
        ...
        <main className="max-w-[680px] mx-auto px-4 py-16 text-center">
          ...
          <p className="text-[#5B5B5B] mb-8">The article you're looking for doesn't exist or has been removed.</p>
          <Button onClick={() => navigate("/")} variant="outline" className="font-ui border-[#D9D9D9]">Return to Homepage</Button>
        </main>
      </div>
    );
  }
