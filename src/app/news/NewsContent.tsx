  ...
  const { data: articlesData, isLoading } = useQuery({
    ...
    queryFn: async () => {
      let query = supabase
        .from("articles")
        .select(
          "id, title, slug, summary, word_count, hero_image_url, published_at, category_slug, author_name, tags",
          { count: "exact" }
        )
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <header className="mb-6">
          <h1 className="font-serif text-3xl md:text-4xl font-bold text-foreground mb-3">News</h1>
