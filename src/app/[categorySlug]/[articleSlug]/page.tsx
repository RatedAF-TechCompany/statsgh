...
export async function generateMetadata({
  ...
  return {
    ...
    twitter: {
      ...
      title: article.title,
      description,
      images: [{ url: absoluteImageUrl, alt: article.title }],
    },
    other: {
...
function generateJsonLd(article: any) {
  ...
  return {
    ...
    publisher: {
      ...
      sameAs: ["https://twitter.com/StatsGH", "https://www.facebook.com/StatsGH"],
    },
...
export default async function ArticlePage({ params }: ArticlePageProps) {
  ...
  // If a bare category slug slips through as an article, hand off to the category page.
