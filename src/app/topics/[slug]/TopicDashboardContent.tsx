...
export default function TopicDashboardContent({ topic }: TopicDashboardContentProps) {
  ...
  // Fetch Ghana data for key indicators
        ...
        <section className="mb-12">
          ...
          {(!indicators || indicators.length === 0) && (
            <Card className="p-8 text-center">
              <p className="text-muted-foreground">No indicators available for this topic yet.</p>
            </Card>
          )}
        </section>
