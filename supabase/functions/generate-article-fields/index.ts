...
6. twitter_post: MUST be 150 characters or fewer. The sentence MUST end conclusively with a full stop — never cut off mid-word or end with ellipsis. If needed, shorten by removing less important details rather than truncating. Must be a full reported sentence starting with the institution/company/subject name. Use active voice with has/said/will/recorded + action/result + key number. Preserve key figures, percentages, and currency values. Use "GHS" for currency and "%" for percentages. No emojis, no hashtags, no commentary. Tone must read like Bloomberg or Financial Times reported speech. Example: "Ghana Water has deployed 200 staff to recover GHS866m debt as 51.6% of water goes unpaid."
