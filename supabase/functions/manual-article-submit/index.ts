...
`.trim();
    ...
    const { data: newArticle, error: insertError } = await supabase
      ...
      .insert({
        ...
        meta_description: String(articleJson.seo_description || "").substring(0, 155),
        og_title: String(articleJson.headline || "").substring(0, 60),
        og_description: String(articleJson.seo_description || "").substring(0, 155),
        twitter_title: String(articleJson.headline || "").substring(0, 60),
        twitter_description: String(articleJson.tweet || "").substring(0, 155),
        source_url: articleSource.sourceUrl,
      })
      .select()
      .single();
