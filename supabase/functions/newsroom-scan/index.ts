...
"subtitle": "",
"summary": "",
"seo_description": "MAX 140 characters — hard limit, full sentence ending with period",
"body_html": "",
"slug": "",
...
ENTITIES RULES: Extract named entities that appear in the article. type must be one of: person, company, ministry, law, indicator, organization. 3-8 items typical. Skip generic terms like "government" or "citizens".`;
      ...
      // ============================================
      // DEDUP (Phase 2 overhaul): the pending_ai duplicate rewriter branch was
      // removed. The main path above already generates + publishes any
      // fresh RSS item; pending_ai items are re-picked on the next run via
      // the normal ingest flow. Keeping only the deferral bookkeeping.
      // ============================================
    }
