  ...
  try {
    ...
    const emailResponse = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        to: [email],
        subject: `You've been invited to join StatsGH as ${role}`,
        html: `
          <!DOCTYPE html>
          <html>
            <head>
              ...
              <title>StatsGH Invitation</title>
            </head>
                      ...
                      <tr>
                        <td style="padding: 40px;">
                          <h2 style="margin: 0 0 16px; font-size: 24px; font-weight: 600; color: #1a1a1a;">
                            Welcome to StatsGH, ${fullName}!
                          </h2>
                          
                          <p style="margin: 0 0 16px; font-size: 16px; line-height: 1.6; color: #525252;">
                            You've been invited by <strong>${invitedBy}</strong> to join the StatsGH content management system.
                          </p>
                      ...
                      <tr>
                        <td style="padding: 24px 40px; border-top: 1px solid #e5e5e5; text-align: center;">
                          ...
                          <p style="margin: 16px 0 0; font-size: 13px; color: #a3a3a3;">
                            © ${new Date().getFullYear()} StatsGH. All rights reserved.
                          </p>
                        </td>
                      </tr>
                    </table>
