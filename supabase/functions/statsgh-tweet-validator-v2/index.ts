...
serve(() =>
  new Response(
    JSON.stringify({
      ...
      retired: true,
      error:
        "statsgh-tweet-validator-v2 is retired. The only automated StatsGH tweet pipeline is tweet-batch-generator (validation + generation) followed by tweet-hourly-poster (posting).",
    }),
    {
      status: 410,
      headers: {
