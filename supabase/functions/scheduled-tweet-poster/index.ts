...
serve(() =>
  new Response(
    JSON.stringify({
      ...
      retired: true,
      error:
        "scheduled-tweet-poster is retired. The only automated StatsGH tweet pipeline is tweet-batch-generator (validation + generation) followed by tweet-hourly-poster (posting).",
    }),
    {
      status: 410,
      headers: {
